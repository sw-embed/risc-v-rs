...
export class WasmCpu {
    ...
    get_flags() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmcpu_get_flags(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function get_challenge_json(id) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.get_challenge_json(id);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 416, function: Function { arguments: [Ref(NamedExternref("Event"))], shim_idx: 452, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
            const ret = makeClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h666b611425fd0cb1, wasm_bindgen__convert__closures________invoke__h838e5ba4303337b6);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 503, function: Function { arguments: [Externref], shim_idx: 527, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
    ...
    return {
        __proto__: null,
        "./risc-v-emulator_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures________invoke__h838e5ba4303337b6(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures________invoke__h838e5ba4303337b6(arg0, arg1, arg2);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('risc-v-emulator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
